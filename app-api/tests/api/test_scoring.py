...
def test_preview_custom_scoring_success(mock_cache, mock_repo, client: TestClient):
    ...
    scoring_request = {
        "season": 2024,
        "week": 10,
        "scoring": {"reception": 1.0, "rec_yd": 0.1, "rec_td": 6.0, "rush_yd": 0.1, "rush_td": 6.0},
        "filters": {"position": "WR"},
        "limit": 200,
        "offset": 0,
    }
...
def test_preview_custom_scoring_with_filters(mock_cache, mock_repo, client: TestClient):
    ...
    scoring_request = {
        "season": 2024,
        "week": 10,
        "scoring": {"reception": 0.5, "rec_td": 6.0},
        "filters": {"position": "RB", "team": "KC", "search": "Hunt"},
        "limit": 50,
        "offset": 0,
    }
...
def test_preview_custom_scoring_invalid_request(client: TestClient):
    ...
    invalid_request = {"season": "invalid", "week": 10, "scoring": {}}
