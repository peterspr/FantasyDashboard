      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="space-y-4">
              <div>
                <label htmlFor="scoring-system" className="block text-sm font-medium text-gray-700 mb-1">
                  Scoring System *
                </label>
                <select
                  id="scoring-system"
              ...
              <div>
                <label htmlFor="league-size" className="block text-sm font-medium text-gray-700 mb-1">
                  League Size *
                </label>
                <select
                  id="league-size"
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              <div className="text-center p-3 bg-gray-50 rounded-md">
                <div className="text-2xl font-bold text-blue-600">
                  {Object.values(team.roster_positions.starters).reduce((sum: number, count: unknown) => sum + Number(count), 0)}
                </div>
                <div className="text-sm text-gray-600">Starting Slots</div>
              </div>
              <div className="text-center p-3 bg-gray-50 rounded-md">
                <div className="text-2xl font-bold text-green-600">{team.roster_positions.bench}</div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 border-2 border-red-200">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Once you delete a team, there is no going back. This will permanently delete your team and all associated data.
            </p>
            {!showDeleteConfirm ? (
              <button
