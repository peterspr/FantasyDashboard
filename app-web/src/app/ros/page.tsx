...
export default function ROSPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Rest of Season Projections</h1>
      ...
      <div className="space-y-6">
        ...
        {error && (
          <div className="bg-red-50 border border-red-200 rounded-md p-4">
            <div className="text-red-800">Error loading ROS projections: {error.message}</div>
          </div>
        )}
