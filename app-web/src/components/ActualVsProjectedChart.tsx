...
export function ActualVsProjectedChart({
  ...
  const minValue = Math.min(...data.map((d) => Math.min(d.projected, d.actual)))
      ...
      {title && (
        <div className="space-y-2">
          ...
          <p className="text-sm text-gray-600">
            Each point represents a player&apos;s projected vs actual fantasy points. Points on the
      ...
      <ResponsiveContainer width="100%" height={400}>
        <ScatterChart margin={{ top: 20, right: 30, left: 20, bottom: 60 }}>
          ...
          <XAxis
            ...
            label={{
              value: 'Projected Fantasy Points',
                ...
                return (
                  <div className="bg-white p-3 border border-gray-200 rounded-lg shadow-lg">
                    ...
                    <div className="space-y-1 mt-2 text-sm">
                      <p>
                        Projected:{' '}
                        <span className="font-medium">{formatNumber(data.projected)}</span>
                      </p>
                      <p>
                        Actual: <span className="font-medium">{formatNumber(data.actual)}</span>
                      </p>
                      <p
